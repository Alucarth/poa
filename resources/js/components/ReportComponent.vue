                    ...
                    <v-layout>
                        ...
                        <v-flex grow pa-1>
                            <multiselect v-model="tipo" :options="lista" placeholder="Selecionar Tipo" label="name"
                                track-by="name" @close="getData()"></multiselect>
                        </v-flex>
                        <v-flex shrink pa-1>
                            <small>
    ...
    export default {
        ...
        methods: {
            ...
            download: function (event) {
                ...
                // self = this;
                if(this.items_selececcionados.length <= 0)
                {
                    toastr.info('Debe Seleccionar al menos una fila de la tabla')
                }else{
